      ...
      <aside class="account-sidebar">
        <div class="user-profile-card">
          <div class="avatar-wrapper">
            ...
            <span class="loyalty-badge">Elite</span>
          </div>
          <h3>
            <c:choose>
              <c:when test="${clienteLogado['class'].name eq 'com.agnello.model.ClientePF'}">
        ...
        <nav class="account-nav-menu">
          ...
          <a href="#" class="nav-item">Meus Pedidos</a>
      ...
      <section class="account-content">
        ...
        <div class="welcome-banner-card">
          <div class="welcome-text">
            ...
            <p>Você possui <strong>12 rótulos</strong> em seu histórico e <strong>R$ 150,00</strong> em créditos de
              cashback disponíveis.</p>
          </div>
          <div class="last-order-preview">
            <span class="preview-label">Último Pedido #7842</span>
            <p class="preview-status">A caminho de São Paulo — Previsão amanhã</p>
          </div>
        </div>
        ...
        <div class="recommendation-section">
          <div class="section-header-flex">
            ...
            <a href="<c:url value='/catalogo'/>" class="see-more-link">Ver catálogo completo →</a>
          </div>
